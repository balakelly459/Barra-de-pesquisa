...
// if($notaTotal >= 6){
//     echo "$nome sua média é: $notaTotal. Você foi aprovado!";
// }elseif($notaTotal > 4 && $notaTotal < 6){
//     echo "$nome sua média é: $notaTotal. Você está de recuperação";
// }else{
//     echo "$nome sua média é: $notaTotal. Você foi reprovado";
// }
